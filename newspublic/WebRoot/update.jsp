...
<div id="content">
	...
	<div id="main">
		<div class="news_list">
		  ...
		  <div class="table">
				<form action="Doupdate?id=${use.id}" method="post">
				<table class="listing" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td class="first style1"><input type="text" value="${use.id}" name="id1"/></td>
						<td><input type="text" value="${use.name}" name="nam"/></td>
						<td><input type="text" value="${use.pwd}" name="pwd"/></td>
					</tr>
